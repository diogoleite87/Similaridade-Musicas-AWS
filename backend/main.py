...
@app.get("/search/{id_playlist}/{num_musicas}/{num_semelhantes}/{valence}/{acousticness}/{danceability}/{energy}/{instrumentalness}/{liveness}/{speechiness}/{customBand}/{nameCustomBand}/{artistCustomBand}")
def run(id_playlist: str, num_musicas: str, num_semelhantes: str,
    ...
    if flagGlobalQueue:
        ...
        try:
            ...
            subtrai_variaveis(id_playlist, valence, acousticness, danceability, energy, instrumentalness, liveness, speechiness, customBand, nameCustomBand, artistCustomBand)
